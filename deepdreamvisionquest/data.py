...
program.append({
  ...
  'features':[157,147,145,137,114,98, 107, 96],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[147,145,137,114,98, 107, 96, 157],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[137,114,98, 107, 96, 157, 147, 145],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[98, 107, 96, 157, 147, 145, 137, 114],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[33, 144, 88, 101, 114, 121, 115],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[144, 88, 101, 114, 121, 115, 33],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[88, 101, 114, 121, 115, 33, 144],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[101, 114, 121, 115, 33, 144, 88],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[114, 121, 115, 33, 144, 88, 101],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
...
program.append({
  ...
  'features':[121, 115, 33, 144, 88, 101, 114],
  'cyclefx':[
	    {
	    	'name': 'inception_xform',
	    	'params': {'scale':0.2}
